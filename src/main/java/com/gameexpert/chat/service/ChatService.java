...
public class ChatService {
    ...
    public ChatMessageResponse saveMessage(Long worldId, String sender, String content) {
        ...
        return new ChatMessageResponse(saved.getSenderNickname(), saved.getContent(), saved.getCreatedAt());
    }
    ...
    public List<ChatMessageResponse> getRecentMessages(Long worldId, int limit) {
        ...
        return recent.stream()
                .map(chatMessage -> new ChatMessageResponse(chatMessage.getSenderNickname(), chatMessage.getContent(), chatMessage.getCreatedAt()))
                .toList();
    }
